...
import { landingPageStyles, cardStyles } from "../assets/dummystyle.js";
import {
  ArrowRight,
  LayoutTemplate,
  Menu,
...
import { ProfileInfoCards } from "../components/Cards.jsx";
      ...
      <header className={landingPageStyles.header}>
        <div className={landingPageStyles.headerContainer}>
          <div className={landingPageStyles.logoContainer}>
            ...
            <span className={landingPageStyles.logoText}>ResumeSmith</span>
          </div>
          {/* mobile menu icon */}
          <button
          ...
          <div className={landingPageStyles.heroGrid}>
            ...
            <div className={landingPageStyles.heroLeft}>
              ...
              <p className={landingPageStyles.description}>
                Create a job-winning resume in minutes with our easy-to-use
                resume builder. ATS friendly , recruiter-approved , and tailored
          ...
          <div className={landingPageStyles.featuresContainer}>
            <div className={landingPageStyles.featuresHeader}>
              ...
              <p className={landingPageStyles.featureDescription}>
                Create and manage multiple resumes for different job roles or
                industries — all under one account.
                <br />
                Download pixel-perfect, ATS-friendly PDF versions of your resume
                with just one click — print-ready and professional.
              </p>
            </div>
            ...
            <div className={landingPageStyles.ctaCard}>
              ...
              <div className={landingPageStyles.ctaCardContent}>
                <h2 className={landingPageStyles.ctaTitle}>
                  Craft the Resume  <span className={landingPageStyles.ctaTitleGradient}>That Gets You Hired </span>
                </h2>
                <p className={landingPageStyles.ctaDescription}>Shape Your Future, One Page at a Time <br />Create. Download. Apply</p>
      ...
      <footer className={landingPageStyles.footer}>
        <div className={landingPageStyles.footerContainer}>
          <p className={landingPageStyles.footerText}>
            © {new Date().getFullYear()} ResumeSmith. Built with ❤️ by Emmanuel Antony
          </p>
        </div>
      </footer>
      {/* Auth Modal*/}
